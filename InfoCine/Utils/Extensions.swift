...
extension UIImageView {
    ...
    func downloaded(from route : APIRouter, link: String, contentMode mode: UIView.ContentMode = .scaleToFill) {
        if let fullUrl = Environment.ImagesURL(type: route, id: link) {
